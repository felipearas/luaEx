exports.main = function(prop) {
  return (`
    ...
    <html data-wf-page="5b6232d17448e365ace2578e" data-wf-site="5b57dbb4061bae8270a56a72">
    <head>
      <meta charset="utf-8">
      <title>User</title>
    ...
    <body>
      <div>
        <div data-collapse="medium" data-animation="default" data-duration="400" class="navbar-2 w-nav">
          <div class="w-container">
            <nav role="navigation" class="nav-menu w-nav-menu"><a href="index.html" class="nav-link-2 w-nav-link">Home</a><a href="core.html" class="nav-link-2 w-nav-link">Orders</a><a href="register.html" class="nav-link-2 w-nav-link">Register</a><a href="user.html" class="nav-link-2 w-nav-link w--current">User</a><a href="check.html" class="nav-link-2 w-nav-link">Check</a><a href="ipfs.html" class="nav-link-2 w-nav-link">IPFS</a></nav>
      ...
      <div class="section-15">
        <div class="container-3 w-container">
          <h1 class="heading-10">USER PAGE</h1>
          <div class="div-block-2">
            <div class="row-4 w-row">
              <div class="column-15 w-col w-col-4">
                <div class="text-block-2 bold">User ID</div>
              </div>
              <div class="column-16 w-col w-col-4">
                <div class="text-block bold">Balance</div>
              </div>
              <div class="column-17 w-col w-col-4"></div>
            </div>
            ` + prop + `
          </div>
        </div>
